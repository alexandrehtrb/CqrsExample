...
namespace CqrsExample.Domain.Features.Shopping.GetList
{
    ...
    {
        private static readonly Error notFoundError = new Error(ShoppingListErrors.ShoppingListNotFound);
        ...
        public async Task<QueryResult<GetShoppingListResult>> HandleAsync(GetShoppingListQuery qry)
        {
            ...
            var qryResult = await repository.QueryAsync<GetShoppingListResult>((Guid) qry.Id!);
