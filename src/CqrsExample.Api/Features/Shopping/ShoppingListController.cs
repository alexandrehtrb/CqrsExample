...
public class ShoppingListController : ControllerBase
{
    ...
    {
        var result = await this.createShoppingListHandler.HandleAsync(cmd);
    ...
    {
        cmd.SetId(id);
        var result = await this.updateShoppingListHandler.HandleAsync(cmd);
    ...
    public async Task<IActionResult> GetShoppingList(Guid? id)
    {
        ...
        var result = await this.getShoppingListHandler.HandleAsync(qry);
